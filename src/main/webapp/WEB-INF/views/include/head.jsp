...
<!-- Main jQuery -->
<script src="${path1}/resources/plugins/jquery/jquery.js"></script>
<script src="${path1}/resources/js/contact.js"></script>
<!--  Magnific Popup-->
<script src="${path1}/resources/plugins/magnific-popup/dist/jquery.magnific-popup.min.js"></script>
<!-- Slick Slider -->
<script src="${path1}/resources/plugins/slick-carousel/slick/slick.min.js"></script>
<!-- Counterup -->
<script src="${path1}/resources/plugins/counterup/jquery.waypoints.min.js"></script>
<script src="${path1}/resources/plugins/counterup/jquery.counterup.min.js"></script>

<script src="${path1}/resources/plugins/modal-video/modal-video.js"></script>
<!-- Google Map -->
